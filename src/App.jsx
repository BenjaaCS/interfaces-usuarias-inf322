...
const App = () => {
  ...
  const publicOptions = useMemo(
    () => new Set(events.map((event) => event.public)),
    [events]
  );
  ...
  const filteredEvents = useMemo(() => {
    ...
    return events.filter((event) => {
      ...
      const matchesPublic =
        filters.public === 'Todos' || event.public === filters.public;
      const matchesDate =
      ...
      return (
        matchesQuery && matchesCategory && matchesPublic && matchesDate
      );
    });
  }, [events, filters]);
  ...
  const currentTitle = filters.selectedDate
    ? `Eventos para el ${formatDate(filters.selectedDate, {
        day: 'numeric',
        month: 'long',
      })}`
    : '';
  ...
  return (
    <div className="min-h-screen bg-gray-100 flex flex-col">
          ...
          <section className="md:col-span-2 space-y-4">
            <div className="bg-white p-6 rounded-lg shadow-md">
              <EventFilters
                ...
                onClearDate={() =>
                  setFilters((c) => ({ ...c, selectedDate: null }))
                }
              />
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              <Calendar
                ...
                onSelectDate={(iso) =>
                  setFilters((c) => ({
                    ...c,
                    selectedDate: c.selectedDate === iso ? null : iso,
                  }))
                }
      ...
      <Modal
        ...
        showClose={false}
        contentClassName="bg-white rounded-lg w-full max-w-2xl shadow-xl"
      >
        {detailEvent && (
          <div>
            ...
            <div className="p-6 space-y-4 text-gray-700">
              <p>
                ...
                {detailEvent.startDate === detailEvent.endDate
                  ...
                  : `Del ${formatDate(detailEvent.startDate)} al ${formatDate(
                      detailEvent.endDate
                    )}`}
              </p>
              <p>
              ...
              <p>
                <strong>Categoría:</strong> {detailEvent.category}
              </p>
              <p>
                <strong>Público:</strong> {detailEvent.public}
              </p>
              <p className="leading-relaxed whitespace-pre-line pt-4">
      ...
      <Modal
        ...
        showClose={false}
        contentClassName="bg-white rounded-lg w-full max-w-4xl shadow-xl"
      >
        {formState.open && (
          <div>
      ...
      <Modal
        ...
        showClose={false}
        contentClassName="bg-white rounded-lg w-full max-w-md shadow-xl"
      >
        <LoginForm
          onLogin={handleLogin}
